...
/**
 * A <code>ElasticConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link ElasticConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-01-01T04:14:22+01:00", comments = "Build UNNAMED.2762.e3b1307")
public class ElasticConnectorLifecycleInjectionAdapter
    extends ElasticConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(ElasticConnectorLifecycleInjectionAdapter.class);
